...
class BootstrapBasedView {
    ...
    <div class="modal fade" role="dialog" style="overflow-y:auto;">
      <div class="modal-dialog">
        ...
        this.imagesContainer = $('<div class="row"></div>');
        this.mainModal = $(`
    <div class="modal fade" role="dialog" style="overflow-y:auto;">
      <div class="modal-dialog">
        <div class="modal-content">
    ...
    `);
        this.modalDelete = $(`<div class="modal fade" role="dialog" style="overflow-y:auto;">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    appendImage(image, addToEnd = false) {
...
exports.default = BootstrapBasedView;
