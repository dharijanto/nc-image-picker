...
class View {
  constructor (divId) {
    ...
    this._modalDeleteCompleted = $('<div class="modal fade" role="dialog"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Modal Delete Successful</h4> </div><div class="modal-body"> <p class="text-center">Your image has been deleted.</p><img src="http://localhost:3300/assets/images/donebutton.png" class="img-responsive" style="margin:0 auto;width:50%;" /> </div><div class="modal-footer" style="text-align:center"> <button type="button" class="btn btn-default" data-dismiss="modal">Back to Image Gallery</button> </div></div></div></div>')
    this._modalDeleteFailed = $('<div class="modal fade" role="dialog"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Modal Delete Failed</h4> </div><div class="modal-body"> <p class="text-center">Internal Server Error!</p><img src="http://localhost:3300/assets/images/xbutton.png" class="img-responsive" style="margin:0 auto;width:50%;" /> </div><div class="modal-footer" style="text-align:center"> <button type="button" class="btn btn-default" data-dismiss="modal">Back to Image Gallery</button> </div></div></div></div>')
    ...
    this._modalUploadFailed = $('<div id="___fileuploadfailed" class="modal fade" role="dialog"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Modal Upload File Failed</h4> </div><div class="modal-body"> <div class="info_result text-center"> <p class="text_message_failed">Failed upload your file !</p><img src="http://localhost:3300/assets/images/xbutton.png" class="img-responsive result_image" style="margin:0 auto;"> <input type="text" readonly value="http://localhost:3300/assets/images/xbutton.png" class="form-control result_image_text"> </div></div><div class="modal-footer"> <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div></div></div></div>')
  ...
  appendImage (dataImage, latest = false) {
    ...
    var urlImages = $('<a href="javascript:void(0);" class="data-image-url" data-url="' + imageURL + '">Click to trigger Callback !!</a>')
